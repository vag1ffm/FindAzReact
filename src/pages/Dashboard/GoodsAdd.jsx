      ...
      <Form onSubmit={handleSubmit} className='mt-3'>
          <Container className='d-flex p-0'>
              ...
              <Form.Group className=' mt-1 col-9' controlId="product-photos">
                  ...
                  <div className="input-group mb-3">
                      <div className="custom-file">
                      <Form.Control type="file" accept="image/png, image/jpeg, image/jpg, image/gif" className="custom-file-input" id="inputGroupFile02" multiple onChange={handlePhotoUpload} style={{ display: 'none' }} />
                      </div>
                      <div className="input-group-append">
